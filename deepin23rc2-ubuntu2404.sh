...
sleep 0.5
curl -o /home/${USER}/Desktop/python3-renpy_8.2.2+dfsg-1_amd64.deb -# http://mirrors.ustc.edu.cn/debian/pool/main/r/renpy/python3-renpy_8.2.2+dfsg-1_amd64.deb
...
sleep 0.5
sudo apt install -y './libjpeg62-turbo_2.1.5-3_amd64.deb' './libpng16-16t64_1.6.43-5_amd64.deb' './libsdl2-image-2.0-0_2.8.2+dfsg-1+b1_amd64.deb'
sudo apt install -y './python3-renpy_8.2.2+dfsg-1_amd64.deb' './python3-pygame-sdl2_8.2.2-1_amd64.deb'
echo -e "\033[36m送归缓存......\033[0m"
sleep 0.5
